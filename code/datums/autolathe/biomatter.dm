...
/datum/design/bioprinter/nt_cells/large/plasma
	...
	materials = list(MATERIAL_STEEL = 3, MATERIAL_BIOMATTER = 15, MATERIAL_PHORON = 3)
...
/datum/design/bioprinter/nt_cells/medium/plasma
	...
	materials = list(MATERIAL_STEEL = 2, MATERIAL_BIOMATTER = 10, MATERIAL_PHORON = 2)
...
/datum/design/bioprinter/nt_cells/small/plasma
	...
	materials = list(MATERIAL_STEEL = 1, MATERIAL_BIOMATTER = 5, MATERIAL_PHORON = 1)
