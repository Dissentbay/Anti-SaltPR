...
#define DISPOSAL_RIDER_DAMAGE 8
	...
	for (var/i in 1 to speed)
		...
		if(hasmob && prob(10))
			for(var/mob/living/H in check_mob(src))
				H.take_overall_damage(DISPOSAL_RIDER_DAMAGE , 0, "Blunt Trauma")//horribly maim any living creature jumping down disposals.  c'est la vie
