...
/obj/item/mecha_parts/part/gygax_armour
	...
	matter = list(MATERIAL_STEEL = 30, MATERIAL_PHORON = 10)
...
/obj/item/mecha_parts/part/phazon_torso
	...
	matter = list(MATERIAL_PLASTEEL = 35, MATERIAL_GLASS = 10, MATERIAL_PHORON = 20)

/obj/item/mecha_parts/part/phazon_head
	name = "Phazon Head"
	icon_state = "phazon_head"
	origin_tech = list(TECH_MATERIAL = 5, TECH_BLUESPACE = 2, TECH_MAGNET = 6, TECH_DATA = 6)
	matter = list(MATERIAL_PLASTEEL = 15, MATERIAL_GLASS = 5, MATERIAL_PHORON = 10, MATERIAL_SILVER = 30)

/obj/item/mecha_parts/part/phazon_left_arm
	name = "Phazon Left Arm"
	icon_state = "phazon_l_arm"
	origin_tech = list(TECH_MATERIAL = 5, TECH_BLUESPACE = 2, TECH_MAGNET = 3)
	matter = list(MATERIAL_PLASTEEL = 20, MATERIAL_PHORON = 10, MATERIAL_SILVER = 3)
...
/obj/item/mecha_parts/part/phazon_armor
	...
	matter = list(MATERIAL_PLASTEEL = 20, MATERIAL_PHORON = 10, MATERIAL_URANIUM = 10, MATERIAL_SILVER = 10, MATERIAL_DIAMOND = 5)
