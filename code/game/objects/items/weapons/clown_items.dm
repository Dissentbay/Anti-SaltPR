...
/obj/item/soap/nanotrasen
	...
	matter = list(MATERIAL_BIOMATTER = 11, MATERIAL_PHORON = 1)
...
/obj/item/soap/bluespase
	...
	matter = list(MATERIAL_BIOMATTER = 10, MATERIAL_PHORON = 3, MATERIAL_GOLD = 3, MATERIAL_SILVER = 3, MATERIAL_DIAMOND = 3)
