...
* Construct *
************/
/obj/item/circuitboard/air_management/construct(obj/machinery/computer/air_control/C)
	if (..(C))
		if(console_name)
...
/obj/item/circuitboard/air_management/supermatter_core/construct(obj/machinery/computer/air_control/supermatter_core/SC)
	if(..(SC))
...
/obj/item/circuitboard/air_management/injector_control/construct(obj/machinery/computer/air_control/fuel_injection/FI)
	if(..(FI))
...
* Deconstruct *
**************/
/obj/item/circuitboard/air_management/deconstruct(obj/machinery/computer/air_control/C)
	if (..(C))
		console_name = C.name
...
/obj/item/circuitboard/air_management/supermatter_core/deconstruct(obj/machinery/computer/air_control/supermatter_core/SC)
	if(..(SC))
...
/obj/item/circuitboard/air_management/injector_control/deconstruct(obj/machinery/computer/air_control/fuel_injection/FI)
	if(..(FI))
